      ...
      <div class="relative max-h-screen overflow-hidden z-1">
        ...
        >
          <div class="p-4 text-center">
            <!-- Responsieve tekst -->
            <h1 class="text-white text-4xl md:text-6xl lg:text-8xl font-bold mb-6 title-line-height">{{ data.title }}</h1>
...
/* Dynamische line-height voor de titel */
.title-line-height {
  line-height: 1.4; /* Standaard regelhoogte */
}

/* Media queries voor verschillende schermgroottes */
@media (max-width: 768px) {
  .title-line-height {
    line-height: 1.3; /* Kleinere interlinie voor mobiel */
  }
}

@media (min-width: 768px) and (max-width: 1024px) {
  .title-line-height {
    line-height: 1.4; /* Interlinie voor tablets en medium schermen */
  }
}

@media (min-width: 1024px) {
  .title-line-height {
    line-height: 1.5; /* Grotere interlinie voor desktop schermen */
  }
}
